...
export const theme = darkMode => ({
  ...
  heroBG: darkMode
    ? 'radial-gradient(76.02% 75.41% at 1.84% 0%, #755139 0%, #021d43 100%)'
  ...
  backgroundColor: darkMode ? '#0f1013' : '#F4F0ED',

  modalBackground: darkMode ? 'rgba(0,0,0,0.6)' : 'rgba(0,0,0,0.5)',
  cardBG: darkMode ? 'rgba(255, 255, 255, .02)' : 'rgba(0, 0, 0, .05)',
  menuBG: darkMode ? 'black' : 'white',
  marqueeBG: darkMode ? '#010101' : '#010101',

  inputBackground: darkMode ? '#202124' : white,
  placeholderGray: darkMode ? '#5F5F5F' : '#E1E1E1',
  shadowColor: darkMode ? '#000' : '#395175',
  ...
  colors: {
    ...
    link: darkMode ? '#395175' : '#755139',
    invertedLink: darkMode ? '#395175' : '#755139'
  },
